...
MIC_SAMPLE_RATE = 16000       # ReSpeaker에서 뽑는 실제 입력 레이트 (장치에 맞게 조정)
MODEL_SAMPLE_RATE = 32000     # PANNs 모델 입력 레이트

PRE_BUFFER_DURATION = 0.2     # 과거 버퍼: 0.2초
DETECT_DURATION = 0.5         # 감지 구간: 0.5초
TARGET_CHANNEL = 0            # 사용할 채널 인덱스
DEVICE_INDEX = 1              # sounddevice 장치 인덱스 (환경에 맞게)
...
NODE_WS_URL = "ws://localhost:8080"   # 같은 PC에서 Node 서버 URL
